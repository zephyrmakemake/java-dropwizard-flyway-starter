...
public class DatabaseConnector {
    ...
    public static Connection getConnection() throws SQLException {
        ...
        try {
            ...
            if (username == null || password == null || host == null || name == null)
                throw new IllegalArgumentException("Add the following properties to env vars: DB_USERNAME, DB_PASSWORD, DB_HOST and DB_NAME");
